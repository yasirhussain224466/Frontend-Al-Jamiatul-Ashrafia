...
function TechnicianReview({ claim }) {
  ...
  // for posting
  const createNotes = useMutation((parameters) => addClaimNotes(parameters), {
    onSuccess: () => {
  ...
  const handleFeedback = () => {
    ...
    const arr = [
      {
        question: "Have you contacted the customer?",
        answer: contactedCustomer ? `yes,` : "no",
      },
      {
        question: "Have customer repairs been scheduled?",
        answer: customerRepairScheduled ? `yes,${scheduledDate}` : "no",
      },
      {
        question: "Have customer repairs been completed?",
        ...
        <div>
          ...
          <div className="questions tech-pad">
            <Toggler
              ...
              unCheckedChildren="No"
              hasLabelBefore={false}
              label="Have customer repairs been scheduled?"
              onChange={() => {
          ...
          <div className="questions tech-pad ">
            <Toggler
              ...
              unCheckedChildren="No"
              hasLabelBefore={false}
              label="Have customer repairs been completed?"
              onChange={() => {
